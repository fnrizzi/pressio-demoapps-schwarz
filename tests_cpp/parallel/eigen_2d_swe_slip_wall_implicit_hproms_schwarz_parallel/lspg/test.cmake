...
set(CMD "python3 ${MESHDRIVER} -n 90 100 --outDir ${OUTDIR}/full_mesh_mono -s ${STENCILVAL} --bounds -5.0 5.0 -5.0 5.0")
...
set(CMD "python3 ${DECOMPDRIVER} --meshScript ${MESHDRIVER} -n 90 100 --outDir ${OUTDIR}/full_mesh_decomp -s ${STENCILVAL} --bounds -5.0 5.0 -5.0 5.0 --numDoms 4 3 --overlap 10")
execute_process(COMMAND ${BASH} -c ${CMD} RESULT_VARIABLE RES)
if(RES)
...
set(CMD "python3 ./gen_sample_mesh.py --outdir ${OUTDIR}")
execute_process(COMMAND ${BASH} -c ${CMD} RESULT_VARIABLE RES)
if(RES)
...
set(CMD "python3 ./gen_trial_space.py --outdir ${OUTDIR}")
execute_process(COMMAND ${BASH} -c ${CMD} RESULT_VARIABLE RES)
if(RES)
